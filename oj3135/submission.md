...
```text
คน N คนนั่งวนเป็นวงกลม เริ่มที่คนที่ 1 จับของ แล้วส่งข้ามทีละ K คน วนไปเรื่อยๆ ถ้าส่งไปโดนขโมย (คนที่ T ) ขโมยจะคว้าหนีทันที แต่ถ้าส่งวนกลับมาถึงคนที่ 1 อีกรอบก็นับว่าจบ ให้หาว่ามีคนได้จับของทั้งหมดกี่คนรวมคนที่ 1 และขโมย
```
