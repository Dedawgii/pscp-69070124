...
```text
รับค่า A,B เป็นจุดเริ่มและจุดจบ รับค่าตัวหาร รับค่าเศษแล้วให้หาว่ามีกี่ตัวที่หารด้วยตัวหารแล้วเหลือเศษที่กำหนด
```
...
```text
รับค่า A,B เป็นจุดเริ่มและจุดจบ รับค่าตัวหาร รับค่าเศษ
หาจำนวนที่ตรงตามเงื่อนไขแล้วบวกเพิ่มไว้ในตัวแปลก่อน
แล้ววนซ้ำจนครบแล้วค่อยแสดงผล
```
...
```text
ช่วงนั้นไม่มีตัวไหนตรงเงื่อนไขเลย
```
