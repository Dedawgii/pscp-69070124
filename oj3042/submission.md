...
```text
รับตัวเลขมาแล้วให้แสดงตัวเลขที่สามารถหารด้วยสิบลงตัวโดยเรียงจากมากไปน้อย โดยแสดง 0 ด้วย
```
...
```text
Step 1: รับตัวเลขจำนวนเต็ม
Step 2: ถ้าหารสิบลงตัวให้แสดงค่านั้นๆแล้ววนเงื่อนไข
```
