...
โจทย์ต้องการ Input ราคารวมของบิลก่อนจะนำไปคำนวณค่าบริการและ Vat แล้วจึงแสดงข้อความของผลลัพธ์
...
Step 1:รับราคาบิลมา
Step 2:คิดค่าบริการ 10% 
Step 3:เช็คเงื่อนไขว่าจะต้องเสีย Vat เท่าไหร่
Step 4:นำผลลัพธ์ทั้งหมดมารวมกับราคา
Step 5:แสดงราคาที่โดยมีทศนิยมแค่สองหลัก
...
Test Case นี้เป็นการลองตัวแปรอื่นๆ
...
แค่ช่วยกันทำความเข้าใจเงื่อนไข

คุณยังทำอะไรด้วยตนเอง

เขียนทั้งหมดด้วยตนเอง
