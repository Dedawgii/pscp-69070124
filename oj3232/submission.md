...
```text
รับอินพุตระยะที่กบสามารถกระโดดได้ และระยะปลายทาง แล้วคำนวณโดยระยะที่กบสามารถกระโดดได้จะลดลงทีละ2 จากนั้นแสดงผลถ้าโดดถึงปลายทางได้ให้หยุดแล้วแสดงจำนวนครั้งที่กระโดด แต่ถ้าไม่ถึงให้แสดง -1
```
