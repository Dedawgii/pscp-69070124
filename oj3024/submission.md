...
```text
รับคะแนนรวมของทั้ง 3 คนและคะแนนสูงสูดของทั้ง 3 คนนี้ เช็คว่าคะแนนที่มากที่สุดและต่ำที่สุดต่างกันเกิน 2 คะแนนมั้ย หากเกินให้แสดง Surprising หากไม่เกินให้แสดง Not surprising
```
...
```text
Step 1:
รับคะแนนรวมของทั้ง 3 คนและคะแนนสูงสูดของทั้ง 3 คน
Step 2:
เช็คว่าคะแนนที่มากที่สุดและต่ำที่สุดต่างกันเกิน 2 คะแนนหรือไม่ 
Step 4:
หากเกินให้แสดง Surprising
หากไม่เกินให้แสดง Not surprising
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก เพราะแนวทางถูกต้อง
```
...
```text
เทสเคสที่คิดว่าไม่ควรผ่าน แต่ผ่าน i Judge
```
...
```text
ช่วยใบ้ว่าเงื่อนไขตอนที่เขียนตอนแรกยังไม่ครบ หากมีกรณีนี้ๆๆ
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำความเข้าใจแล้วลองช่วยกันคิดเงื่อนไขเพิ่มกับคู่ Pair
```
