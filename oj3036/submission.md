...
```text
โจทย์ให้หาว่าต้องพังกำแพงกี่กำแพงจากจุดเริ่มไปห้องเลข1
```
...
```text
Step 1: รับอินพุตตัวเลขจำนวนเต็ม
Step 2: หาตำแหน่งและแถว
Step 3: คำนวณระยะทาง
Step 4: แสดงจำนวนกำแพงที่ต้องพัง
```
