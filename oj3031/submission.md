...
```text
รับจำนวนเต็ม S แทนพื้นที่ที่น้ำหมึกแผ่ขยายไปต่อหนึ่งวินาที จำนวนเต็ม N แทนจำนวนคำร้องจากผู้คน
รับค่าบรรทัดที่ i + 1  ระบุจำนวนเต็ม Xi และ Yiแทนพิกัดของบ้านของคนที่ i N บรรทัด ในบรรทัดที่ i ระบุจำนวนเต็มหนึ่งตัว ตอบคำถามของคนที่ i ว่าบ้านของเขาจะถูกน้ำท่วมในวินาทีที่เท่าใด
```
