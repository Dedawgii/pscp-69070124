...
| OJ submission ID, if submitted | 586010 |
| OJ status | Pass |
...
```text
ได้เรียนรู้การคิดวางแผน
ได้เรียนรู้การค้นคว้าข้อมูลที่ไม่รู้
ได้ลองแก้ไขข้อผิดพลาดอย่างการเปลี่ยนไปใช้ while เนื่องจาก  for จะเกิดตัวแปรที่ไม่ได้ใช้
```
