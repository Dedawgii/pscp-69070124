...
```text
รับค่าอุณหภูมิตั้งต้น หน่วยตั้งต้นและหน่วยที่ต้องการแปลงไปเป็น แล้วจึงแสดงผลเป็นอุณหภูมิของหน่วยที่แปลงแล้ว
```
...
```text
รับอุณหภูมิ หน่วยตั้งต้นและหน่วยที่ต้องการแปลง เช็คเงื่อนไขหน่วยตั้งต้นเป็นตัวไหนต้องการแปลงเป็นหน่วยไหนแล้วเข้าสูตรคำนวณแล้วจึงแปลง แสดงเอาท์พุต
```
