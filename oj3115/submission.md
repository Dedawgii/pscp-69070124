...
```text
เช็คว่าเวลาที่ตรวจสอบแต่ละเวลามีกี่ร้านที่สามารถตรวจสอบได้
```
...
```text
รับจำนวนร้าน และจำนวนเวลาที่จะเช็ค
รับเวลาเปิดปิดแต่ละร้าน
รับเวลาเช็คตามจำนวนที่รับมา
เช็คว่าแต่ละเวลาเช็คอยุ่ในเวลาเปิดปิดร้านมั้ย
แสดงผลลัพธ์เป็นจำนวนที่เช็คได้ของแต่ละเวลาแต่อยู่ในบรรทัดเดียวกันหมดโดยเว้นวรรค
```
...
```text
การนับแบบเปิดครอบคลุมและนับขอบช่วงเวลา
```
...
```text
ร้านเปิดตลอดวัน และร้านที่ไม่มีเวลาทับซ้อนกัน
```
...
```text
ตรวจสอบเวลานอกช่วงเปิดของทุกร้าน
```
