...
```text
รับอินพุตฉลากรางวัล และฉลากของเราเป็นตัวอักษรและชุดตัวเลข5ตัว โดยเว้นว่างระหว่างตัวอักษรกับชุดตัวเลข เช็คตามเงื่อนไขในโจทย์ว่าตรงยังไงได้เท่าไหร่บ้าง ถ้าไม่ตรงเลยให้แสดง 0
```
