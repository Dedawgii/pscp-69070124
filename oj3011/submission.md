...
โจทย์ต้องการ Input ข้อความเป็นชื่อสีจากแม่สีมาสองสี แล้วแสดง Output เป็นชื่อสีที่เกิดจากการผสมของสีจาก Input
...
Step 1:รับชื่อสีจากแม่สี
Step 2:เช็ค Input ผ่านเงื่อนไขการผสมสีต่างๆ
Step 3:แสดงข้อความชื่อสีผลลัพธ์
...
เหมือนกัน เนื่องจากเงื่อนไขทุกอย่างถูกต้องแล้ว
...
Test Case นี้เป็นอันที่ไม่ได้ใส่ .Capitalize()
...
ไม่แสดงผลลัพธ์เนื่องจากไม่ถูกต้องตามเงื่อนไขเพราะค่าที่รับไม่ได้ขึ้นต้นด้วยตัวพิมพ์ใหญ่
...
Test Case นี้เป็นอันที่ยังขาดเงื่อนไขของสีบางสีอยู่
...
เพื่อนในคณะที่รู้จัก

เขาช่วยอะไร

ได้ปรึกษาและคุยกับเพื่อนเรื่องขาดตกบกพร่องอะไรไป โดยเฉพาะตรงเงื่อนไขสีที่เพื่อนช่วยบอกว่ายังไม่ครบ

คุณยังทำอะไรด้วยตนเอง

เขียยนโค้ดและคิดเงื่อนไขด้วยตนเอง
