...
```text
ให้หาว่าตั้งแต่ตัวเลขเริ่มต้นถึงตัวเลขสุดท้าย มีเลขอะไรบ้างที่เป็นจำนวนเฉพาะ ให้แสดงเลขเหล่านั้นออกมาทั้งหมด แล้วตามด้วยการบอกว่านับรวมแล้วได้ทั้งหมดกี่จำนวน
```
