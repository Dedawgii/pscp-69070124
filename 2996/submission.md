...
โจทย์ต้องการ Input ข้อความจำนวน 5 ตัวอักษรและทำการอ่านค่าย้อนกลับก่อนจะแสดงข้อความ Output ออกมาเป็นตัวพิมพ์เล็กทั้งหมด เป็นข้อความจาก Input แต่เขียนกลับหลัง
...
Step 1:รับข้อความมา 5 ตัวอักษร
Step 2:สลับตำแหน่งตัวอักษรที่กำหนด (เนื่องจากไม่ได้มอง Test Case ตัวอย่างแล้วยังเข้าใจโจทย์ผิดอยู่)
Step 3:แสดงข้อความออกมา
...
Step 1:รับข้อความมา 5 ตัวอักษร
Step 2:เขียนข้อความที่ได้รับมาย้อนหลังพร้อมทำเป็นพิมพ์เล็กทั้งหมด
Step 3:แสดงข้อความออกมา
...
เป็น Test Case ที่สำเร็จและทำงานถูกต้อง 100% 
...
Test Case นี้เป็นช่วงที่ยังไม่ได้ใส่ .lower() ทำให้ได้ผลลัพธ์ไม่ตรงตามทีต้องการ
...
Test Case นี้คือเมื่อตอนที่ยังไม่รู้เรื่อง Index ในการทำให้โค้ดอ่านค่าย้อนหลังและยังเข้าใจโจทย์ผิดนึกว่าสลับตัวอักษรไม่ใช่การเขียนย้อนหลังเพราะไม่ได้มอง Test Case ตัวอย่าง จึงทำได้แค่รับค่า Input เพียงอย่างเดียว ก่อนจะเข้าใจจากการอธิบายจาก AI 
...
ยังไม่เข้าใจเลยไม่มีภาพในหัวเลยครับ
...
ไม่ได้ส่งด้วยครับ แต่น่าจะออกมาเป็น Not Pass 
