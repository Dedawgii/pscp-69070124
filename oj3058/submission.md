...
```text
คำนวณว่าจะสามารถสร้างสะพานจากอิฐจากที่มีได้มั้ย ถ้าได้จะใช้อิฐก้อนใหญ่ให้ได้มากที่สุดแล้วจะใช้ก้อนเล็กกี่ก้อนให้แสดงผล
```
...
```text
Step 1: รับค่าความยาวที่ต้องการ
Step 2: ตวจว่าใช้ก้อนใหญ่ได้มากสุดกี่ก้อน
Step 3: ต้องใช้ก้อนเล็กกี่ก้อน
Step 4: แสดงผล
```
